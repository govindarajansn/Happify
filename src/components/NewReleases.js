...
const NewReleases = (props) =>{
    ...
    if (data === null) {
        ...
        if(responseStatus === 200){
            return(
                <>
                <div className="index"><h1 style={{ paddingLeft: "15px" }}>Featured Albums</h1></div>
                                ...
                                <div className="card-body">
                                    <h5 className="card-title text-uppercase">{item.name}</h5>
                                        <p className="card-text">{item.description}</p>
                                        {
                                            ...
                                            <a href={"artist/"+musician.id} class="card-link">{musician.name}</a>
                                        )}
                                        <div>
                                            <a href={"album/"+item.id} className="btn btn-info btn-block">View Details</a>
                                        </div>
                                </div>
                            </div>
                        </div>
